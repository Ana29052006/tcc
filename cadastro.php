                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="home.php" alink="#fff" text="#fff">Home</a></li>
                            <li class="breadcrumb-item"><a href="carrinho.php" alink="#fff" text="#fff">Pages</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page" text="#fff">cadastro</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h1 class="text-white mb-4">cadastro de clientes</h1>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-primary w-100 py-3" type="submit">Entrar</button>
                                      <br>
                                      <a href="login.php" class="link-login">Já tem um cadastro?</a>
                                </div>
                            </div>
                    </div>
                </div>
